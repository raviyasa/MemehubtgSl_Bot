...
async def startprivate(client, message):
    ...
    text = f"Hi {message.from_user.mention}, 👋, Welcome to  <> ᴍͥʀ.ᷧ ⷨසා̥̏ත̆̈න්̅ 🇱🇰 </> {Oғғʟɪɴᴇ} Assistant Bot. You Can Contact [<> ᴍͥʀ.ᷧ ⷨසා̥̏ත̆̈න්̅ 🇱🇰 </> {Oғғʟɪɴᴇ}](https://t.me/Mr_Saathan_Official) By me🥲."  
